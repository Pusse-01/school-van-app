                ...
                child: Column(
                  children: [
                    Container(
                      child: Row(
                        children: [
                          Text('Bus Driver', style: TextStyle(
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () async{
                          if(email.text.trim()!=""&&password.text.trim()!=""&&name.text.trim()!=""&& driving.text.trim().isNotEmpty&&NIC.text.trim().isNotEmpty&&contact.text.trim().isNotEmpty&&address.text.trim().isNotEmpty) {
